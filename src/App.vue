 ...
 <div class="wrapper">
  <div class="intro">
    <div class="profile">
      ...
      <div class="bio">
        <h1 class="name">Joshua Ezekiel T. Limiac</h1>
        <p class="profession" style="color: black; font-weight: bold;">Second Year Student</p>
      </div>
    </div>
    <div class="intro-section about">
      <h1 class="title">objective</h1>
      <p class="paragraph">
        To get an opportunity where I can make the best of my potential and contribute to the organization's growth. Seeking a position in a company where I can launch my career and build a valuable skill set.
      </p>
    </div>
    <div class="intro-section contact">
      ...
      <div class="info-section">
        ...
        <span>limiacjoshua09@gmail.com</span>
      </div>
    </div>
    <div class="intro-section follow">
      ...
      <div class="info-section link">
        ...
        <a target="_blank" rel="author" href="https://github.com/limiacJosh">
          <span>github.com/limiacJosh</span>
          <div class="info-section link">
        <i class="fab fa-facebook"></i>
        <a target="_blank" rel="author" href="https://www.facebook.com/pandeboomyy">
          <span>facebook.com/pandeboomyy</span>
        </a>
      </div>
        </a>
      </div>
    ...
    <div class="detail-section edu">
      ...
      <div class="detail-content">
        <div class="timeline-block">
          <h1>Bachelor of Science Major in Information Technology - Web Development</h1>
        ...
        <div class="timeline-block">
          <h1>High School</h1>
          <p>Holy Angel University</p>
          <p>Tinajero High School Annex</p>
          <time>2014 - 2018</time>
        </div>
        <div class="timeline-block">
          <h1>Elementary School</h1>
          <p>Cabalantian Elementary School</p>
          <time>2008 - 2014</time>
        </div>
      </div>
    </div>
